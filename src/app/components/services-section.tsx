...
export function ServicesSection() {
  ...
  return (
    <section id="services" className="py-20 lg:py-8 scroll-mt-20">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12">
          <SectionHeading
            eyebrow={tr({ fr: "Nos services", en: "Our services" })}
            title={tr({ fr: "Une approche intégrée au service de l'impact", en: "An integrated approach in service of impact" })}
            subtitle={tr({
            ...
            >
              ...
              >
                <div className="flex items-start justify-between mb-5">
                  <div className={`grid place-items-center size-12 rounded-xl ${s.iconBgClassName ?? "bg-primary/10"} ${s.iconClassName ?? "text-primary"}`}>
